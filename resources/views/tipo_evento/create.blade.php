...
<div class="card">
    <div class="card-body">
        <form action="{{ route('tipo_evento.store') }}" method="post">
            @csrf
            @method('POST')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="color" value="{{ old('fondo') }}" id="color_fondo" style="width: 10%;" class="form-control" aria-label="fondo">
                    @error('fondo')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <!-- El input de color tiene un ancho del 20% -->
                    <input type="color" value="{{ old('border') }}" id="color_border" style="width: 10%;" class="form-control" aria-label="border">
                    @error('border')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <!-- El input de color tiene un ancho del 20% -->
                    <input type="color" value="{{ old('texto') }}" id="color_texto" style="width: 10%;" class="form-control" aria-label="texto">
                    @error('texto')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
